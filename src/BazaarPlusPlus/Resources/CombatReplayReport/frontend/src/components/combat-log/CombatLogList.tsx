...
function CombatLogTargetDetail({
  ...
  return (
    <Button
      ...
      className="grid h-8 w-full grid-cols-[4rem_clamp(10rem,24%,14rem)_minmax(0,1fr)_1rem_minmax(0,1fr)_4.5rem] items-center justify-stretch gap-x-2 gap-y-0 rounded-none border-b border-border/15 bg-surface-raised/25 px-3 text-left font-normal transition-colors hover:bg-accent/35 max-[600px]:grid-cols-[3.5rem_1.25rem_minmax(0,1fr)_0.75rem_minmax(0,1fr)_auto] max-[600px]:gap-x-1.5 max-[600px]:px-2"
              ...
              return (
                ...
                >
                  <Button
                    ...
                    className={cn(
                      "grid h-9 w-full grid-cols-[4rem_clamp(10rem,24%,14rem)_minmax(0,1fr)_1rem_minmax(0,1fr)_4.5rem] items-center justify-stretch gap-x-2 gap-y-0 rounded-none border-b border-border/20 px-3 text-left font-normal transition-colors hover:bg-accent/40 max-[600px]:grid-cols-[3.5rem_1.25rem_minmax(0,1fr)_0.75rem_minmax(0,1fr)_auto] max-[600px]:gap-x-1.5 max-[600px]:px-2",
