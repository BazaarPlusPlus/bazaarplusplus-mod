...
test("renders the same behavioral contract in all supported locales", async ({
  ...
  const expectations = [
    ["en", "Timeline", "Statistics", "Generated by BazaarPlusPlus 4.6.0-test"],
    ["zh-CN", "时间轴", "统计", "由 BazaarPlusPlus 4.6.0-test 生成"],
    ["zh-Hant", "時間軸", "統計", "由 BazaarPlusPlus 4.6.0-test 產生"],
  ];

  for (const [locale, timeline, statistics, attribution] of expectations) {
