...
> Status: IMPLEMENTED at master (PR #10 merge 5eca53df, impl commit e7d0c27a; p3-cleanup 0bd32f76). M3 confirmed by probe: occluder is a sibling pooled tooltip clone. Fix rewritten to root-canvas sortingOrder +1 (ElevatedSortingStep=1); sibling SetAsLastSibling, overrideSorting writes, threshold 101, and NativeTooltipForeground token all deleted.
