...
> Status: IMPLEMENTED at master 90ba7120 "Redesign history panel filters" (merge f70d88fd, 2026-06-20); all three goals shipped: Runs single-select hero filter, Ghost >=10-day toggle, pinned non-scrolling _filterSlot, compact detail card.
