...
> Status: IMPLEMENTED at master (intro 408f65ef 2026-06-12, refined c9cb3c0c 2026-07-04); all 5 planned files shipped and registered. Doc's literal order numbers are stale (HotkeyTutorial now 14, BazaarDb 15) but the row still sits immediately before BazaarDB.
