...
> Status: ABANDONED: fully implemented then fully reverted. Custom-card foundation + achievement cards shipped 2026-06-19 (18bfda3f "feat: add custom achievement cards") plus fixes, then entirely removed 2026-06-30 (4904d30f, b2a66a77, 0de611e6, 2b4e1d80). No achievement/CustomCards/CardArtReplacement code at HEAD; only residue is CollectionTabKind.cs reduced to {Items, Skills}.
