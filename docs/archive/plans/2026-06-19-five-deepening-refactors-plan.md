...
> Status: IMPLEMENTED at HEAD; C1/C4/C2/C3 shipped in planned order (C1 upload pump 90f1adb0+9e00b007, C4 muxer 435dc550, C2 CollectionQuery 85f6135a, C3 HistoryPanel f4536eb8), C5 dropped with all three Core seams kept (REJECTED — do not re-propose).
