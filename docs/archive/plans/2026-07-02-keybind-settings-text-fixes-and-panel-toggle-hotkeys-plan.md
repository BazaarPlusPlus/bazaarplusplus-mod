...
> Status: IMPLEMENTED at master e8fc4d30 (2026-07-02); all 10 tasks shipped (localized conflict warning, live-control key display, 3 rebindable panel-toggle actions + config/labels/settings rows), NativeKeybindLabelPatch deleted. Consumption path later centralized into OverlayPanelHost (a3690e9d).
