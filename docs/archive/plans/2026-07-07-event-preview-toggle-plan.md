...
> Status: IMPLEMENTED at master 5fc946fd (2026-07-07); Part A toggle + B1 dump-diagnostic removal + B2 cctor->Plugin.cs move all shipped; only user in-game validation left pending.
