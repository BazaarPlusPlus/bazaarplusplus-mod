...
> Status: IMPLEMENTED at merge f68ad2b1 (2026-07-06); all 5 planned touchpoints shipped verbatim (TooltipModifierRefreshController re-resolves open preview tooltips on Ctrl/Shift hold-state change), no tests added as planned.
