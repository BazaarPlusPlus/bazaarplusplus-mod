...
> Status: IMPLEMENTED at master (commits 5ab415a5, 4904d30f, b2a66a77, 0de611e6); Achievements tab/catalog/custom-card foundation fully deleted, zero residue in src/tests at HEAD; the "keep package art" parts superseded by sibling remove-package-art-and-tab plan (package art also since removed).
