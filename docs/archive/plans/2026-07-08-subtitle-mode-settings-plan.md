...
> Status: IMPLEMENTED at master 91622637 (2026-07-08); all 5 steps landed in one merge: four-state Subtitle Mode dock row, VoiceSubtitlesLanguageSettingsDockEntry deleted, order constants collapsed, config descriptions reworded (keys unchanged), tests rewritten.
