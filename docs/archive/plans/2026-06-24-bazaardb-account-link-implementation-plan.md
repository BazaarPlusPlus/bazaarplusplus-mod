...
> Status: IMPLEMENTED: the plan's BazaarDbLinkClient/link-card path shipped via merge dd9fdc8f (2026-07-02) and manual-link + online gate 88f7f5ae (2026-07-06); client built at Plugin.cs:181-195 on a dedicated 30s HttpClient as planned. Companion design doc archived alongside.
