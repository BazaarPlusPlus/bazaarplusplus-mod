...
- DDL: `bazaarplusplus-server/migrations/0001_v4_initial.sql`
- Wire contract: `bazaarplusplus-server/docs/api-reference.md`
- Upload write path: `bazaarplusplus-server/src/features/runBundles/upload.ts`
- Ghost query: `bazaarplusplus-server/src/features/ghostBattles/query.ts`
