...
- **本地化**：`CollectionPanelText`（[CollectionPanelText.cs:11](../../../src/BazaarPlusPlus/Game/CollectionPanel/Text/CollectionPanelText.cs#L11)）；header 用 `LocalizedTextSet`（如 `TierHeader`，第 32–37 行）；数字无需逐项本地化。
