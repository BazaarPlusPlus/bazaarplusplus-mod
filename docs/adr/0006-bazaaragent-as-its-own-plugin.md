...
- The pure core remains `System` + `Newtonsoft.Json` only, enforced by architecture tests ([project](../../src/BazaarPlusPlus.BazaarAgent/BazaarPlusPlus.BazaarAgent.csproj#L1-L14), [test](../../tests/Architecture.Tests/CoreLayeringTests.cs#L885-L902)).
- Installing the host enables fixed-loopback `127.0.0.1:47900`; removing it disables the bridge. There is no runtime enable/port config ([defaults](../../src/BazaarPlusPlus.BazaarAgent/Contract/BazaarAgentPorts.cs#L6-L27)).
- A default build must scrub both optional DLLs; `--with-bazaaragent` builds and copies them ([main project](../../src/BazaarPlusPlus/BazaarPlusPlus.csproj#L148-L192), [run.sh](../../run.sh#L82-L89)).
