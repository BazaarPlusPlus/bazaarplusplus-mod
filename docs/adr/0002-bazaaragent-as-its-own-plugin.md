...
- The pure core remains `System` + `Newtonsoft.Json` only, enforced by architecture tests ([project](../../src/BazaarPlusPlus.BazaarAgent/BazaarPlusPlus.BazaarAgent.csproj#L1-L14), [test](../../tests/Architecture.Tests/CoreLayeringTests.cs) — `BazaarAgent_core_has_only_portable_dependencies`).
