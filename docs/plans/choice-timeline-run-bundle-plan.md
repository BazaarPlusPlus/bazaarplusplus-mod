> Status (2026-07-10 consolidation): PENDING, zero implementation started; awaiting sign-off on the §11 open decisions (local always-on recording? offer-snapshot field depth? HistoryPanel consumer). Promoted from docs/drafts/.
