...
note: "CollectionPanel hero portrait chips are implemented. HistoryPanel still uses text hero pills, so only the HistoryPanel replacement remains active."
---
...
> 关联：[../ARCHITECTURE.md#history-panel-item-boards-and-live-build](../ARCHITECTURE.md#history-panel-item-boards-and-live-build)（当前 HistoryPanel 结构）、[../archive/design/archive/2026-05-29-historypanel-fullscreen-responsive-design.md](../archive/design/archive/2026-05-29-historypanel-fullscreen-responsive-design.md)（全屏外壳前身）、[../archive/design/2026-05-31-collection-panel-design.md](../archive/design/2026-05-31-collection-panel-design.md)（同样用「GUID/枚举 → 游戏原生资源」的取图思路）。
