    ...
    public void Playback_persistence_and_warmup_events_match_the_locked_manifest_schemas()
    {
        ...
        var expected = new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["combat_replay.current_recording.presentation_gate_resolved"] =
                "recording_id:Public:High:Short|outcome:Public:Low:None|expected_items:Public:Low:None|visible_items:Public:Low:None|face_up_items:Public:Low:None|settled_items:Public:Low:None|elapsed_ms:Public:High:None",
            ["combat_replay.saved_recording.presentation_gate_resolved"] =
                "battle_id:Public:High:Short|source:Public:Low:None|outcome:Public:Low:None|expected_items:Public:Low:None|visible_items:Public:Low:None|face_up_items:Public:Low:None|settled_items:Public:Low:None|elapsed_ms:Public:High:None",
