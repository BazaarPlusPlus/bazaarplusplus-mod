...
public class BazaarAgentActionQueueTests
{
    ...
    {
        var q = new BazaarAgentActionQueue(timeoutMilliseconds: 5_000);
    ...
    {
        var q = new BazaarAgentActionQueue(timeoutMilliseconds: 50);
        var task = q.EnqueueAndAwaitAsync(WaitAction());
        var res = await task;
    ...
    {
        var q = new BazaarAgentActionQueue(timeoutMilliseconds: 30);
    ...
    {
        var q = new BazaarAgentActionQueue(timeoutMilliseconds: 60_000);
