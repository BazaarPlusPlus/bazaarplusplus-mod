...
var conversionMethod = converterType.GetMethod("BuildCachedSpecs", BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Static);
Assert(conversionMethod != null, "EncounterPreviewSpecConverter should expose BuildCachedSpecs for structured cache conversion.");

var previewCardType = typeof(RunInfo).GetNestedType("MonsterPreviewCard", BindingFlags.Public);
Assert(previewCardType != null, "RunInfo.MonsterPreviewCard should exist for structured cached preview data.");

var cards = CreateList(previewCardType!);
cards.Add(CreateCard(previewCardType!, "11111111-1111-1111-1111-111111111111", 2, 3, "Crusher", "None"));
cards.Add(CreateCard(previewCardType!, "22222222-2222-2222-2222-222222222222", 1, 1, "Howl", "None"));
...
Assert((string)GetProperty(converted[0], "TemplateId")! == "11111111-1111-1111-1111-111111111111", "Template id should be preserved.");
...
Assert((string)GetProperty(converted[1], "SourceName")! == "Howl", "Source name should be preserved.");
...
static object CreateCard(Type cardType, string templateId, int tier, int size, string sourceName, string enchant)
{
